            ...
            <div class="row-fluid">
                ...
                <div id="layout-content" class="span12">
                    ...
                    <div id="note"><strong>Welcome to kokoropy.</strong><br />
                        This page was generated by <code>application.index.controllers.index</code>
                        which is located at <code>application/index/controllers/index.py</code>
                        (Have a look at the file, it is well commented)<br />
                        Kokoropy has 3 types of page routing method:
                        <ul>
                            <li><span class="method">Procedural with manual routing</span> (use @route decorator)
                                <ul>
                                    <li><code>/hello_world</code> is mapped into <code>application.index.controllers.index.index</code></li>
                                </ul>
                            </li>
                            <li><span class="method">OOP with default routing</span> (use <strong>Default_Controller</strong> class. The published function should has <strong>action</strong> prefix<br />
                                ...
                                <ul>
                                    <li><code>/</code> is mapped into <code>application.index.controllers.index.Default_Controller.action</code></li>
                                    <li><code>/index</code> is mapped into <code>application.index.controllers.index.Default_Controller.action_index</code></li>
                                </ul>
                            </li>
                            <li><span class="method">OOP with manual routing</span> (use route function)
                                <ul>
                                    <li><code>/hello?name=some_name</code> is mapped into <code>application.index.controllers.index.hello_controller.hello_get</code></li>
                                    <li><code>/hello/some_name</code> is mapped into <code>application.index.controllers.index.hello_controller.hello_param</code></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
