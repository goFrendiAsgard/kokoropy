...
class Country(Model):
    ...
    country_friends = relationship("Rel_Country_Friends", foreign_keys="Rel_Country_Friends.fk_left_country")
    friends = association_proxy("country_friends", "fk_right_country", creator=lambda _val: Rel_Country_Friends(right_country = _val))
    country_enemies = relationship("Rel_Country_Enemies", foreign_keys="Rel_Country_Enemies.fk_left_country")
    enemies = association_proxy("country_enemies", "fk_right_country", creator=lambda _val: Rel_Country_Enemies(right_country = _val))
    country_commodities = relationship("Rel_Country_Commodities", foreign_keys="Rel_Country_Commodities.fk_country")
    commodities = association_proxy("country_commodities", "fk_commodity", creator=lambda _val: Rel_Country_Commodities(commodity = _val))
...
class Rel_Country_Friends(Model):
    ...
    left_country = relationship("Country", foreign_keys="Rel_Country_Friends.fk_left_country")
    right_country = relationship("Country", foreign_keys="Rel_Country_Friends.fk_right_country")
...
class Rel_Country_Enemies(Model):
    ...
    fk_left_country = Column(Integer, ForeignKey("country._real_id"))
    fk_right_country = Column(Integer, ForeignKey("country._real_id"))
    left_country = relationship("Country", foreign_keys="Rel_Country_Enemies.fk_left_country")
    right_country = relationship("Country", foreign_keys="Rel_Country_Enemies.fk_right_country")
...
class Rel_Country_Commodities(Model):
    ...
    country = relationship("Country", foreign_keys="Rel_Country_Commodities.fk_country")
    commodity = relationship("Commodity", foreign_keys="Rel_Country_Commodities.fk_commodity")
